...
//                    }
    ...
    public void openSettings(){
        ...
        ArrayList<KeyValueBean> autoscoring_sel = new ArrayList(Arrays.asList(new KeyValueBean(0,"Disable"),new KeyValueBean(1,"Enable"),new KeyValueBean(2,"Manual"), new KeyValueBean(3, "Sensors")));
