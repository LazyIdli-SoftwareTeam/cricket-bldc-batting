 ...
 * @author possi
 */
public class HomeScreenButton1 extends Group{
    
    public HomeScreenButton1(Image image1,Image image2,double width , double height){
    ...
    public HomeScreenButton1(Image image , String text,Color color){
        try {
