 ...
 */
public class TextType3_0 extends Text{
    double x_in_mm=0;
    double y_in_mm=0;
    public TextType3_0(double x_in_mm , double y_in_mm , String value , Font font , Pane pane){
        super(value);
        setFont(font);
    ...
    public TextType3_0(double x_in_mm , double y_in_mm , String value , Font font , Pane pane ,Color textcolor){
        super(value);
        setFill(textcolor);
        setFont(font);
        this.x_in_mm=x_in_mm;
